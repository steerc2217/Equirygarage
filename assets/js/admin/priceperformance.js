    ...
    var initTable1 = function() {
        ...
        var table = $('#kt_datatable').DataTable({
            ...
            ajax: {
                ...
                url: base_url +'index.php/PricePerformance/get_Data',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'Id', 'Ticker', 'Date', '1Day_Percent', '2Day_Percent','3Day_Percent','4Day_Percent','5Day_Percent',
                        'WTD_Percent', 'MTD_Percent', 'YTD_Percent', 'Actions'
                    ],
                },
            },
            columns: [{
